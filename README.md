...
## Requirements
To support the widest range of users while ensuring stability on modern hardware, this plugin requires:
- **OBS Studio:** 29.1.0 or newer
- **Operating Systems:**
  - **Windows 10** (Version 1809 or newer)
  - **macOS 11** (Big Sur or newer) - Supports both Intel and Apple Silicon
- **Qt Version:** Built against Qt 6.5.3 LTS for maximum compatibility
